...
const file_Security_proto_rawDesc = "" +
	...
	"TokenProto\x12\x1e\n" +
	"\n" +
	"identifier\x18\x01 \x02(\fR\n" +
	"identifier\x12\x1a\n" +
	"\bpassword\x18\x02 \x02(\fR\bpassword\x12\x12\n" +
	"\x04kind\x18\x03 \x02(\tR\x04kind\x12\x18\n" +
	"\aservice\x18\x04 \x02(\tR\aservice\"s\n" +
	"\x12CredentialsKVProto\x12\x14\n" +
	"\x05alias\x18\x01 \x02(\tR\x05alias\x12/\n" +
	"\x05token\x18\x02 \x01(\v2\x19.hadoop.common.TokenProtoR\x05token\x12\x16\n" +
	"\x06secret\x18\x03 \x01(\fR\x06secret\"\x8a\x01\n" +
	"\x10CredentialsProto\x129\n" +
	"\x06tokens\x18\x01 \x03(\v2!.hadoop.common.CredentialsKVProtoR\x06tokens\x12;\n" +
	"\asecrets\x18\x02 \x03(\v2!.hadoop.common.CredentialsKVProtoR\asecrets\":\n" +
	"\x1eGetDelegationTokenRequestProto\x12\x18\n" +
	"\arenewer\x18\x01 \x02(\tR\arenewer\"R\n" +
	"\x1fGetDelegationTokenResponseProto\x12/\n" +
	"\x05token\x18\x01 \x01(\v2\x19.hadoop.common.TokenProtoR\x05token\"S\n" +
	" RenewDelegationTokenRequestProto\x12/\n" +
	"\x05token\x18\x01 \x02(\v2\x19.hadoop.common.TokenProtoR\x05token\"I\n" +
	"!RenewDelegationTokenResponseProto\x12$\n" +
	"\rnewExpiryTime\x18\x01 \x02(\x04R\rnewExpiryTime\"T\n" +
	"!CancelDelegationTokenRequestProto\x12/\n" +
	"\x05token\x18\x01 \x02(\v2\x19.hadoop.common.TokenProtoR\x05token\"$\n" +
	"\"CancelDelegationTokenResponseProtoBm\n" +
	" org.apache.hadoop.security.protoB\x0eSecurityProtosZ3github.com/nirvam/go-hdfs-fsimage/pkg/fsimage/types\x88\x01\x01\xa0\x01\x01"
