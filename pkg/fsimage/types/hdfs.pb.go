...
type LocatedBlockProto struct {
	...
	BlockTokens   []*TokenProto `protobuf:"bytes,10,rep,name=blockTokens" json:"blockTokens,omitempty"`  // each internal block has a block token
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LocatedBlockProto) GetBlockToken() *TokenProto {
	if x != nil {
		return x.BlockToken
	}
	return nil
...
func (x *LocatedBlockProto) GetBlockTokens() []*TokenProto {
	if x != nil {
...
const file_hdfs_proto_rawDesc = "" +
	...
	"\rtypeQuotaInfo\x18\x01 \x03(\v2&.hadoop.hdfs.StorageTypeQuotaInfoProtoR\rtypeQuotaInfo\"\x80\x01\n" +
	"\x19StorageTypeQuotaInfoProto\x121\n" +
	"\x04type\x18\x01 \x02(\x0e2\x1d.hadoop.hdfs.StorageTypeProtoR\x04type\x12\x14\n" +
	...
	"\vblockTokens\x18\n" +
	" \x03(\v2\x19.hadoop.common.TokenProtoR\vblockTokens\"\xde\x01\n" +
	...
	"\berrorMsg\x18\x03 \x01(\tR\berrorMsg\"Y\n" +
	...
	"\fstripeLength\x18\x02 \x01(\x04R\fstripeLength\"\xd2\x03\n" +
	...
	"storageIds\x18\b \x03(\tR\n" +
	"storageIds\x12(\n" +
	"\x0fhandshakeSecret\x18\t \x01(\fR\x0fhandshakeSecret*N\n" +
	...
	"HdfsProtosZ3github.com/nirvam/go-hdfs-fsimage/pkg/fsimage/types\xa0\x01\x01"
...
var file_hdfs_proto_goTypes = []any{
	...
	(*TokenProto)(nil),                          // 57: hadoop.common.TokenProto
